...
public class DetalheConsole extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exclui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (quant > 1) {
                    ...
                    Toast.makeText(DetalheConsole.this, "Selecione ao menos 1", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adicionaItem();
                Intent intent = new Intent(DetalheConsole.this, MainActivity.class);
    ...
    private void pegaItem() {
        ...
        dtoConsoles = (DtoConsoles) intent.getSerializableExtra("jogos");

        txtNome.setText(dtoConsoles.getNome());
        txtDesc.setText(dtoConsoles.getDescricao());
        Picasso.get().load(dtoConsoles.getIdImagem()).into(imgProd);
        txtCateg.setText(dtoConsoles.getCategoria());
        preco = dtoConsoles.getPreco();
    ...
    private void adicionaItem() {
        ...
        String id_img = dtoConsoles.getIdImagem();
        ...
        call.enqueue(new Callback<Boolean>() {
            ...
            public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(DetalheConsole.this, "Produto adicionados com sucesso!", Toast.LENGTH_SHORT).show();
                } else {
                    Log.d("erros", "não foi");
                }
            }
            ...
            public void onFailure(Call<Boolean> call, Throwable t) {
                Toast.makeText(DetalheConsole.this, "erro" + t.getMessage(), Toast.LENGTH_SHORT).show();
